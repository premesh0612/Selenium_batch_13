...
public class TestScript{
	...
	@Test(dataProviderClass = SeleniumDay20_DataProvider.TestData.class, dataProvider = "loginTestData")
	public void TestCase1(String uname, String pass) throws InterruptedException {
		...
		driver.findElement(By.cssSelector("input[placeholder='Email']")).sendKeys(uname);
